<div>
    <div>
        <form method="POST" wire:submit.prevent="update">
            <div>
                <div class="mb-6">
                    <x-label for="title" class="mb-1 text-base">Tipo</x-label>
                ...
                <div class="mb-6">
                    <x-label for="body" class="mb-1 text-base">Contenido del Inicio</x-label>
                    <textarea name="content" id="content" wire:model.lazy="content" cols="30" rows="5"
                              ...
                              placeholder="Contenido del inicio"></textarea>
                    @error('content')
                    <div class="text-red-500 text-sm">
                        {{ $message }}
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="my-5 w-80">
                        ...
                        <img src="{{ Storage::url($image) }}" alt="{{ 'Imagen del inicio ' . $Titulo }}">
                    </div>
